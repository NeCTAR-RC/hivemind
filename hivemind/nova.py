...
UBUNTU = {'trusty': 'f0677256-6268-405c-8dab-56ff01e901ab',
          'precise': '0824aac4-91a9-4e1d-ad86-02ce6443d4b1'}
...
def boot(name, key_name, image_id=None, flavor='m1.small',
         ubuntu=sorted(UBUNTU.keys()), security_groups=DEFAULT_SECURITY_GROUPS,
